        ...
        <div className="max-w-[1600px] mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
             <div className="flex items-center gap-2 text-gray-800">
                ...
                <h1 className="text-xl font-bold">Create Sub Document Category</h1>
             </div>
             <button 
          ...
          <div className="bg-white rounded shadow-sm border border-gray-100">
            <div className="px-6 py-4 border-b border-gray-100">
               <h2 className="text-[#0061f2] text-[14px] font-bold">Add New Sub Document Category</h2>
            </div>
            <div className="p-6 space-y-6">
               ...
               <div className="space-y-2">
                  <label className="text-[13px] text-gray-600 font-medium">Sub Category Name <span className="text-red-500">*</span></label>
                  <input type="text" placeholder="ENTER SUB CATEGORY NAME" className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded text-[13px] text-gray-700 focus:outline-none focus:border-[#0061f2] transition-all" />
               </div>
    ...
    <div className="p-6 bg-[#f8f9fc] min-h-screen font-sans">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
           <div className="flex items-center gap-2 text-gray-800">
              <FolderOpen className="w-5 h-5 text-gray-800" />
              <h1 className="text-xl font-bold">Sub Document Categories</h1>
           </div>
           <button 
        ...
        <div className="bg-white rounded shadow-sm border border-gray-100">
          <div className="px-6 py-4 border-b border-gray-100">
             <h2 className="text-[#0061f2] text-[14px] font-bold">All Sub Document Categories</h2>
          </div>
          <div className="p-6">
                ...
                <table className="w-full text-[13px] border-collapse">
                   <thead>
                      <tr className="bg-[#f8f9fc] text-gray-900 font-bold border-b border-gray-200">
                         ...
                         <th className="px-6 py-4 text-left border-r border-gray-200">Sub Category Name</th>
