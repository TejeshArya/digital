...
import { 
  ...
  Save, FileText, Info, History, ArrowRight, 
  X, RotateCcw, Settings, CheckCircle2, 
  List, Clock, Image as ImageIcon, Upload
} from 'lucide-react';

export function Categories() {
  const [categories] = useState([
    { 
      name: 'CIVIL', desc: 'CIVIL WORKS', date: '2026-03-13', 
      photo: 'https://images.unsplash.com/photo-1541913057-22122752670d?q=80&w=200&auto=format&fit=crop' 
    },
    { 
      name: 'ELECTRONIC ITEMS', desc: 'ELECTRONICS', date: '2026-02-27', 
      photo: 'https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=200&auto=format&fit=crop' 
    },
    { 
      name: 'ELECTRICAL', desc: 'desc', date: '2025-12-23', 
      photo: 'https://images.unsplash.com/photo-1454165833767-027ffea9e778?q=80&w=200&auto=format&fit=crop' 
    },
  ]);
      ...
      <div className="max-w-[1600px] mx-auto space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-[#0061f2] px-8 py-5">
             <h2 className="text-white text-[12px] font-black uppercase tracking-widest">Add Category</h2>
          </div>
          <div className="p-8 grid grid-cols-1 md:grid-cols-4 gap-8 items-end">
             <div className="space-y-2 md:col-span-1">
                ...
                <input type="text" placeholder="Category name" className="w-full px-4 py-3 bg-white border border-gray-100 rounded-lg text-[13px] font-bold text-gray-700 focus:outline-none focus:border-blue-400 transition-all shadow-inner" />
             </div>
             <div className="space-y-2 md:col-span-1">
              ...
              <table className="w-full text-[11px] border-collapse">
                 <thead>
                    <tr className="bg-white text-gray-400 uppercase tracking-widest border-b border-gray-100">
                       ...
                       <th className="px-8 py-6 text-center font-black border-r border-gray-50">Category Name</th>
                    ...
                    {categories.map((item, idx) => (
                      <tr key={idx} className="hover:bg-gray-50/50 transition-colors group">
                         <td className="px-8 py-4 border-r border-gray-50 text-center">
                            <div className="w-24 h-24 mx-auto rounded-lg overflow-hidden border border-gray-100 shadow-sm relative group/img">
                               <img src={item.photo} alt={item.name} className="w-full h-full object-cover grayscale group-hover/img:grayscale-0 transition-all" />
                               <div className="absolute inset-0 bg-black/0 group-hover/img:bg-black/10 transition-all"></div>
                            </div>
                         </td>
