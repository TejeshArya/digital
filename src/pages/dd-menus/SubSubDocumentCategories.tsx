...
import { 
  Plus, Edit3, Trash2, FolderSync, 
  ArrowLeft, X, Save, ChevronDown
} from 'lucide-react';
        ...
        <div className="max-w-[1600px] mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
             <div className="flex items-center gap-2 text-gray-800">
                <FolderSync className="w-5 h-5 text-gray-800" />
                <h1 className="text-xl font-bold">Create Sub-Sub Document Category</h1>
             </div>
             <button 
          ...
          <div className="bg-white rounded shadow-sm border border-gray-100">
            <div className="px-6 py-4 border-b border-gray-100">
               <h2 className="text-[#0061f2] text-[14px] font-bold">Add New Sub-Sub Document Category</h2>
            </div>
            <div className="p-6 space-y-6">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div className="space-y-2">
                    <label className="text-[13px] text-gray-600 font-medium">Document Category <span className="text-red-500">*</span></label>
                 ...
                 <div className="space-y-2">
                    <label className="text-[13px] text-gray-600 font-medium">Sub Document Category <span className="text-red-500">*</span></label>
                    <div className="relative">
                       <select className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded text-[13px] text-gray-700 focus:outline-none focus:border-[#0061f2] transition-all appearance-none">
               ...
               <div className="space-y-2">
                  <label className="text-[13px] text-gray-600 font-medium">Sub-Sub Category Name <span className="text-red-500">*</span></label>
                  <input type="text" placeholder="ENTER SUB-SUB CATEGORY NAME" className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded text-[13px] text-gray-700 focus:outline-none focus:border-[#0061f2] transition-all" />
               </div>
    ...
    <div className="p-6 bg-[#f8f9fc] min-h-screen font-sans">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
           <div className="flex items-center gap-2 text-gray-800">
              <FolderSync className="w-5 h-5 text-gray-800" />
              <h1 className="text-xl font-bold">Sub-Sub Document Categories</h1>
           </div>
           <button 
           ...
           >
              <Plus className="w-4 h-4" /> Add New Sub-Sub Category
           </button>
        </div>
        ...
        <div className="bg-white rounded shadow-sm border border-gray-100">
          <div className="px-6 py-4 border-b border-gray-100">
             <h2 className="text-[#0061f2] text-[14px] font-bold">All Sub-Sub Document Categories</h2>
          </div>
          <div className="p-6">
                ...
                <table className="w-full text-[13px] border-collapse">
                   <thead>
                      <tr className="bg-[#f8f9fc] text-gray-900 font-bold border-b border-gray-200">
                         ...
                         <th className="px-6 py-4 text-left border-r border-gray-200">Category</th>
                         <th className="px-6 py-4 text-left border-r border-gray-200">Sub Category</th>
                         <th className="px-6 py-4 text-left border-r border-gray-200">Sub-Sub Category Name</th>
                         <th className="px-6 py-4 text-left border-r border-gray-200">Description</th>
                         <th className="px-6 py-4 text-left border-r border-gray-200 w-28">Status</th>
                         <th className="px-6 py-4 text-left border-r border-gray-200 w-32">Created At</th>
                   ...
                   <tbody className="divide-y divide-gray-200">
                      {docs.map((item, idx) => (
                        <tr key={idx} className="hover:bg-gray-50/50 transition-colors">
                           ...
                           <td className="px-6 py-3 border-r border-gray-200 font-bold text-gray-500 uppercase">{item.category}</td>
                           <td className="px-6 py-3 border-r border-gray-200 font-bold text-gray-500 uppercase">{item.subCategory}</td>
