...
export function Denom() {
  const [denoms] = useState([
    { name: 'MON', short: 'MON', desc: 'Months', date: '2026-04-17 09:59:45' },
    { name: 'OTHER', short: 'OTHER', desc: 'Other', date: '2026-03-27 20:55:30' },
    { name: 'PERDAY', short: 'PERDAY', desc: 'Per day', date: '2026-03-23 17:59:40' },
    { name: 'CUM', short: 'CUM', desc: 'Cubic meter', date: '2026-03-13 07:29:19' },
    { name: 'EA', short: 'EA', desc: 'Ea', date: '2026-03-13 07:25:53' },
    { name: 'MT', short: 'MT', desc: 'Metric ton', date: '2026-03-13 07:25:31' },
    { name: 'SQM', short: 'SQM', desc: 'Sqare meter', date: '2026-03-13 07:25:18' },
    { name: 'PACKS', short: 'PAC', desc: 'Pac', date: '2026-02-27 09:30:00' },
    { name: 'BOTTLES', short: 'BTL', desc: 'Btl', date: '2026-02-27 09:28:47' },
    { name: 'DRUM', short: 'DRM', desc: 'Drm', date: '2026-02-27 09:28:32' },
  ]);
  ...
  return (
    <div className="p-4 bg-[#f8f9fc] min-h-screen font-sans">
      <div className="max-w-[1600px] mx-auto space-y-8">
        {/* Form Card */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
           <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Denom name</label>
              <input type="text" placeholder="Denom name" className="w-full px-4 py-3 bg-white border border-gray-100 rounded-lg text-[13px] font-bold text-gray-700 focus:outline-none focus:border-blue-400 transition-all shadow-inner" />
           </div>
           <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Denom short name</label>
              <input type="text" placeholder="Denom short name" className="w-full px-4 py-3 bg-white border border-gray-100 rounded-lg text-[13px] font-bold text-gray-700 focus:outline-none focus:border-blue-400 transition-all shadow-inner" />
           </div>
           <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Denom Description</label>
              ...
              <table className="w-full text-[11px] border-collapse">
                 <thead>
                    <tr className="bg-white text-gray-400 uppercase tracking-widest border-b border-gray-100 font-black">
                       <th className="px-8 py-5 text-left border-r border-gray-50">Denom Name</th>
