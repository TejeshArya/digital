...
export function SubCategories() {
  const [subs] = useState([
    { 
      category: 'CIVIL', sub: 'JAMANAR NEI PROJECT', desc: 'JAMANAR NEI PROJECT', date: '2026-03-13', 
      photo: 'https://images.unsplash.com/photo-1541913057-22122752670d?q=80&w=200&auto=format&fit=crop' 
    },
    { 
      category: 'ELECTRONIC ITEMS', sub: 'ELECTRONICS ITEMS', desc: 'ELECTRONICS', date: '2026-02-27', 
  ...
  return (
    <div className="p-4 bg-[#f8f9fc] min-h-screen font-sans">
      <div className="max-w-[1600px] mx-auto space-y-8">
        {/* New Sub Category Form Card */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-[#0061f2] px-8 py-5">
             <h2 className="text-white text-[12px] font-black uppercase tracking-widest">New Sub Category</h2>
          </div>
          <div className="p-8 space-y-6">
             <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="space-y-2">
                   ...
                   <input type="text" placeholder="Sub Category" className="w-full px-4 py-3 bg-white border border-gray-100 rounded-lg text-[13px] font-bold text-gray-700 focus:outline-none focus:border-blue-400 transition-all shadow-inner" />
                </div>
                <div className="space-y-2">
             ...
             <div className="flex justify-end">
                <button className="px-12 py-3.5 bg-[#1cc88a] text-white text-[11px] font-black rounded shadow-lg shadow-emerald-100 uppercase tracking-widest hover:bg-emerald-700 transition-all">
                   Save Sub Category
                </button>
             </div>
          </div>
                      ...
                      <tr key={idx} className="hover:bg-gray-50/50 transition-colors group text-center">
                         <td className="px-8 py-4 border-r border-gray-50">
                            <div className="w-24 h-24 mx-auto rounded-lg overflow-hidden border border-gray-100 shadow-sm">
                               <img src={item.photo} alt={item.sub} className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all" />
                            </div>
                         </td>
                         <td className="px-8 py-4 border-r border-gray-50 font-bold text-gray-400 uppercase tracking-tight">{item.category}</td>
                         <td className="px-8 py-4 border-r border-gray-50 font-black text-gray-600 uppercase tracking-tight">{item.sub}</td>
